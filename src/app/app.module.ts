...
import { NutritionReportComponent } from './recipes/recipe-detail/nutrition-report/nutrition-report.component';
...
@NgModule({
  ...
  providers: [ShoppingListService, RecipeService, DataUpdateService],
